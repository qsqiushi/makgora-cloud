...
@Service
public class RedissonManagerServiceImpl {
  ...
  public static void init(String key, String value) {
    try {
      /*
       * config.useClusterServers() //这是用的集群server .setScanInterval(2000) //设置集群状态扫描时间
       * .setMasterConnectionPoolSize(10000) //设置连接数 .setSlaveConnectionPoolSize(10000)
