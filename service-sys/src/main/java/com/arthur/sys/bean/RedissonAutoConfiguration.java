...
public class RedissonAutoConfiguration {
   ...
   */
  @Bean
  @ConditionalOnProperty(name = "master-name",prefix="spring.redisson.")
  RedissonClient redissonSentinel() {
    System.out.println("master-name created");
   ...
   */
  @Bean
  @ConditionalOnProperty(name = "address",prefix="spring.redisson.")
